  ...
  return (
    <footer className="relative bg-white text-gray-800 shadow-md">
      <div className="absolute bottom-0 left-0 right-0 overflow-hidden">
        ...
        >
          <path
            fill="rgba(255,165,0,0.2)" // Warna oranye transparan
          ...
          ></path>
          <path
            fill="rgba(255,165,0,0.4)" // Warna oranye transparan yang lebih gelap
      ...
      <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 relative z-10"> {/* Mengurangi padding vertical */}
        
        <div className="mt-4 text-center text-sm"> {/* Mengurangi margin atas */}
